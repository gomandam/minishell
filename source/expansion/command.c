...
/*   Updated: 2025/09/11 18:26:41 by migugar2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

static int	expand_cmd_words(t_shell *shell, t_cmd *cmd, t_argv *argv)
{
	int		is_assign;
	int		first_expand;
	t_tok	*next;
